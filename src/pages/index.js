...
const formAddCardValidator = new FormValidator(config, constants.popupAddCardForm);
const formEditProfileValidator = new FormValidator(config, constants.editProfileForm);
const formEditAvatarValidator = new FormValidator(config, constants.editAvatarForm);

const section = new Section(addCard, '.gallery__grid');
const popupWithImage = new PopupWithImage('.popup_image');
const popupAddImage = new PopupWithForm('.popup_add-card', handleCardFormSubmit, 'Добавляем карточку...');
const popupEditProfile = new PopupWithForm('.popup_profile', handleProfileFormSubmit, 'Сохраняем...');
const popupEditAvatar = new PopupWithForm('.popup_avatar-edit', handleEditAvatarFormSubmit, 'Меняем аватар...');
const popupDeleteCard = new PopupWithConfirm('.popup_delete-confirm', 'Удаляем карточку...');
